...
def main():
    ...
    json_directory = Path(__file__).resolve().parent
    json_pointer = str(current_working_directory) + "/param.json"   
    ...
    item_refs_list, item_pass_list = lvlI.level_1_size_and_mass(item_refs_list, item_pass_list, json_pointer, file_pointer)
    item_refs_list, item_pass_list = lvlII.level_2_size_and_mass(item_refs_list, item_pass_list, file_pointer)
    item_refs_list, item_pass_list = lvlIII.level_3_size_and_mass(item_refs_list, item_pass_list, json_pointer, file_pointer)
